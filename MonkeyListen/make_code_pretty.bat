astyle --style=gnu --indent=spaces=4 --indent-switches --indent-labels --indent-preprocessor --indent-col1-comments --break-blocks --align-pointer=name --break-after-logical --lineend=windows --suffix=none --recursive  Sources/*.h  Sources/*.c 
